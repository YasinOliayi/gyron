...
class Update:
    ...
    def __init__(self, data_Message, instance):
        ...
        if 'reply_to_message' in message_data:
            self.reply_to_message = ReplyMessage(
    ...
    def user_id(self):
        ...
        if self.callback_query:
            return self.callback_query.author.id

        elif self.pre_checkout_query:
            return self.pre_checkout_query.author.id
...
class PreCheckoutQuery:
    ...
    __slots__ = ('id', 'currency', 'total_amount',
                 'invoice_payload', 'author', "_raw")
...
class Media:
    ...
    __slots__ = ('id', 'unique_id', 'width', 'height',
                 'duration', 'mime_type', 'size', "_raw", "thumb")
...
class Sticker:
    ...
    __slots__ = ('id', 'unique_id', 'type', 'width', 'height',
                 'is_animated', 'is_video', 'set_name', 'size', 'thumb', "_raw")
...
class SuccessfulPayment:
    ...
    __slots__ = ('currency', 'total_amount', 'invoice_payload',
                 'telegram_payment_charge_id', 'provider_payment_charge_id', "_raw")
    ...
    def __init__(self, data):
        ...
        self.total_amount = data.get('total_amount')
        self.invoice_payload = data.get('invoice_payload')
        self.telegram_payment_charge_id = data.get(
            'telegram_payment_charge_id')
        self.provider_payment_charge_id = data.get(
...
class Invoice:
    ...
    __slots__ = ('title', 'description', 'start_parameter',
                 'currency', 'total_amount', "_raw")
...
class ChatFullInfoPhoto:
    ...
    __slots__ = ('small_id', 'small_unique_id',
                 'big_id', 'big_unique_id', "_raw")
...
class ChatFullInfoSelfAcceptedGiftTypes:
    ...
    __slots__ = ('unlimited_gifts', 'limited_gifts',
                 'unique_gifts', 'premium_subscription', "_raw")
...
class ChatFullInfo:
    ...
    def __init__(self, data):
        ...
        self.accepted_gift_types = ChatFullInfoSelfAcceptedGiftTypes(
            result.get('accepted_gift_types', {}))
...
class File:
    ...
    __slots__ = ('ok', 'id', 'unique_id', 'size', 'path',
                 "_raw", 'error_code', 'error_description')
...
class ChatAdministratorsResponse:
    ...
    __slots__ = ("ok", "administrators", "_raw",
