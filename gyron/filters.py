...
class filters:
    ...
    def is_joined(*chat_ids: Union[str, int]):
        ...
        async def _filter(message: Update):
            ...
            if user_id is None and message.callback_query is not None:
    
                user_id = message.callback_query.author.id

            if user_id is None and message.pre_checkout_query is not None:

                user_id = message.pre_checkout_query.author.id
